const G=()=>{const m=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${m}px`)};G();window.addEventListener("resize",G);const V=()=>{const m=document.getElementById("preloader"),w=document.getElementById("preloaderBar");if(m&&w){document.body.style.overflow="hidden";let e=0,n=document.readyState==="complete";const o=setInterval(()=>{if(e>=100){clearInterval(o),w.style.width="100%",setTimeout(()=>{m.classList.add("fade-out"),document.body.style.overflow="",setTimeout(()=>{m.remove()},800)},250);return}n?e+=5:e<85?e+=1.5:e+=.1,w.style.width=`${Math.min(e,100).toFixed(1)}%`},20);window.addEventListener("load",()=>{n=!0}),setTimeout(()=>{n=!0},3e3)}window.lucide&&window.lucide.createIcons();const I=document.getElementById("navbar");window.addEventListener("scroll",()=>{window.scrollY>40?I.classList.add("navbar-scrolled"):I.classList.remove("navbar-scrolled")});const q=document.getElementById("menuBtnOpen"),k=document.getElementById("menuBtnClose"),x=document.getElementById("menuPanel"),J=document.querySelectorAll(".menu-link-item");function U(){x.classList.add("active"),document.body.style.overflow="hidden"}function T(){x.classList.remove("active"),document.body.style.overflow=""}q&&k&&x&&(q.addEventListener("click",U),k.addEventListener("click",T),J.forEach(e=>{e.addEventListener("click",T)}));const X=document.querySelectorAll(".metric-num"),E=document.getElementById("hero-projects-count"),S=(e,n=1500)=>{const s=parseInt(e.getAttribute("data-target")||e.innerText,10);let o=0;const r=Math.max(Math.floor(n/s),15),i=setInterval(()=>{o+=Math.ceil(s/(n/r)),o>=s?(e.innerText=s,clearInterval(i)):e.innerText=o},r)};E&&(E.setAttribute("data-target","321"),setTimeout(()=>S(E,1200),200));const _={threshold:.2,rootMargin:"0px 0px -50px 0px"},K=new IntersectionObserver((e,n)=>{e.forEach(s=>{if(s.isIntersecting){const o=s.target;S(o,1500),n.unobserve(o)}})},_);X.forEach(e=>{K.observe(e)});const B=document.getElementById("pricingToggle"),M=document.getElementById("toggleMonthly"),j=document.getElementById("toggleAnnually"),v=document.getElementById("price-basic"),f=document.getElementById("price-premium"),b=document.getElementById("price-ultimate");function Z(){B.classList.toggle("annually")?(M.classList.remove("active"),j.classList.add("active"),d(v,v.getAttribute("data-annual")),d(f,f.getAttribute("data-annual")),d(b,b.getAttribute("data-annual"))):(j.classList.remove("active"),M.classList.add("active"),d(v,v.getAttribute("data-monthly")),d(f,f.getAttribute("data-monthly")),d(b,b.getAttribute("data-monthly")))}function d(e,n){e&&(e.style.opacity="0",e.style.transform="translateY(-5px)",setTimeout(()=>{e.innerText=n,e.style.opacity="1",e.style.transform="translateY(0)"},150))}B&&B.addEventListener("click",Z);const H=document.querySelectorAll(".faq-item");H.forEach(e=>{const n=e.querySelector(".faq-question-btn"),s=e.querySelector(".faq-answer");n.addEventListener("click",()=>{const o=e.classList.contains("active");H.forEach(r=>{r.classList.remove("active"),r.querySelector(".faq-answer").style.maxHeight="0"}),o||(e.classList.add("active"),s.style.maxHeight=s.scrollHeight+"px")})});const P=document.querySelectorAll(".scroll-fill-title");P.forEach(e=>{e.style.setProperty("--fill-pct","0%")});const y=new Set,ee=new IntersectionObserver(e=>{e.forEach(n=>{n.isIntersecting?y.add(n.target):n.target.getBoundingClientRect().top>0&&(y.delete(n.target),n.target.style.setProperty("--fill-pct","0%"))})},{threshold:0,rootMargin:"0px 0px -5% 0px"});P.forEach(e=>ee.observe(e));let L=null;function z(){const e=window.innerHeight;y.forEach(n=>{const s=n.getBoundingClientRect(),o=e*.82,r=e*.18,i=(o-s.top)/(o-r),c=Math.max(0,Math.min(1,i));n.style.setProperty("--fill-pct",`${(c*100).toFixed(1)}%`),c>=1&&y.delete(n)}),L=null}window.addEventListener("scroll",()=>{L||(L=requestAnimationFrame(()=>{z()}))},{passive:!0}),z();const C=document.querySelector(".realisations-section"),p=document.querySelector(".realisations-track"),F=document.querySelector(".realisations-track-container");if(C&&p&&F){let n=function(){if(window.innerWidth<=768){p.style.transform="";return}const s=C.getBoundingClientRect(),o=window.innerHeight,r=C.offsetHeight-o;if(r<=0)return;const i=-s.top,c=Math.max(0,Math.min(1,i/r)),l=p.scrollWidth-F.clientWidth;l>0?p.style.transform=`translateX(${-c*l}px)`:p.style.transform="",e=null};var re=n;let e=null;window.addEventListener("scroll",()=>{e||(e=requestAnimationFrame(n))},{passive:!0}),window.addEventListener("resize",()=>{e||(e=requestAnimationFrame(n))}),n()}const $=document.querySelector(".method-timeline-grid"),O=document.querySelectorAll(".method-timeline-step");$&&O.length>0&&new IntersectionObserver((n,s)=>{n.forEach(o=>{o.isIntersecting&&(O.forEach((r,i)=>{setTimeout(()=>{r.classList.add("reveal-visible")},i*300)}),s.unobserve(o.target))})},{threshold:.15}).observe($);const u=document.getElementById("hero");if(u){let s=function(){const o=window.scrollY,r=u.offsetHeight||600;if(o<=r){u.style.visibility="visible";const i=o/r;e&&(e.style.opacity=Math.max(0,1-i*1.5).toFixed(2),e.style.transform=`translateY(${i*60}px)`),n&&(n.style.transform=`scale(${1.02-i*.02})`)}else u.style.visibility="hidden"};var ie=s;const e=u.querySelector(".hero-content-wrapper"),n=u.querySelector(".hero-bg-layer");window.addEventListener("scroll",s,{passive:!0}),s()}(()=>{const e=window.location.pathname.includes("/cases/")||window.location.pathname.includes("/articles/")?"../":"";document.body.insertAdjacentHTML("beforeend",`
        ...
        `);const s=document.getElementById("arenaChatTrigger"),o=document.getElementById("arenaChatWindow"),r=document.getElementById("arenaChatClose"),i=document.getElementById("arenaChatBadge"),c=document.getElementById("arenaChatForm"),l=document.getElementById("arenaChatInput"),g=document.getElementById("arenaChatBody");if(!s||!o||!r||!c||!l||!g)return;const A=()=>{const a=o.classList.toggle("open");s.classList.toggle("active"),a&&(i&&(i.style.display="none"),setTimeout(()=>l.focus(),300))};s.addEventListener("click",A),r.addEventListener("click",A);const D=document.querySelector(".navbar-chat-circle");D&&D.addEventListener("click",a=>{a.preventDefault(),o.classList.contains("open")||A()});const te=()=>{const a=new Date,t=String(a.getHours()).padStart(2,"0"),h=String(a.getMinutes()).padStart(2,"0");return`${t}:${h}`},N=()=>{g.scrollTop=g.scrollHeight},R=(a,t)=>{const h=te(),Y=`
                <div class="arena-chat-message ${a}">
                    <div class="arena-chat-msg-wrapper">
                        <div class="arena-chat-msg-bubble">${t}</div>
                        <span class="arena-chat-msg-time">${h}</span>
                    </div>
                </div>
            `,Q=document.getElementById("arenaChatSuggestions");Q?Q.insertAdjacentHTML("beforebegin",Y):g.insertAdjacentHTML("beforeend",Y),N()},ne=()=>{const a=`
            ...
            `,t=document.getElementById("arenaChatSuggestions");t?t.insertAdjacentHTML("beforebegin",a):g.insertAdjacentHTML("beforeend",a),N()},se=()=>{const a=document.getElementById("arenaChatTypingIndicator");a&&a.remove()},oe=a=>{const t=a.toLowerCase();return t.includes("service")||t.includes("offre")||t.includes("propos")||t.includes("niveau")||t.includes("fait")||t.includes("conseil")||t.includes("stratég")||t.includes("expertis")||t.includes("compétenc")?`Notre expertise s'articule autour de 4 piliers de services concrets :<br><br>
                    ...
                    Quelle option préférez-vous explorer ?`},W=a=>{a.trim()&&(R("user",a),l.value="",ne(),setTimeout(()=>{se();const t=oe(a);R("bot",t)},1e3+Math.random()*500))};g.addEventListener("click",a=>{const t=a.target.closest(".arena-chat-suggestion-chip");if(t){const h=t.getAttribute("data-question");W(h)}}),c.addEventListener("submit",a=>{a.preventDefault(),W(l.value)})})()};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",V):V();
